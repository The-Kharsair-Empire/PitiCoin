...
network = f'https://ropsten.infura.io/v3/{infura_project_id}'
...
contract = w3.eth.contract(address=factory_addr, abi=factory_abi)
...
event_filter_1 = contract.events.PairCreated.createFilter(fromBlock='latest')
